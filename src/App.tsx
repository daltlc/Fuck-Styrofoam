    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50">
      ...
      <header className="bg-red-600 text-white shadow-lg">
        <div className=" mx-auto px-4 py-8">
          ...
          <p className="text-xl text-red-100">
            I also just hate the feel of it, don't you?
          </p>
          <p className="text-sm text-red-200 mt-2">
            Community-powered database | Help us grow by reporting offenders
          </p>
        </div>
      </header>
        ...
        <div className="flex items-start">
          ...
          <div>
            <p className="text-orange-900 font-semibold">
              Why styrofoam (EPS) is terrible:
            </p>
            <ul className="text-orange-800 text-sm mt-2 space-y-1">
              <li>• Takes 500+ years to decompose in landfills</li>
              <li>
                • Breaks into microplastics that contaminate ecosystems and
                oceans
              </li>
              <li>
                • Non-recyclable in most areas (despite misleading recycling
                symbols)
              </li>
              <li>
                • Made from petroleum - a non-renewable fossil fuel resource
              </li>
              <li>
                • Animals mistake foam pieces for food, causing injury and death
              </li>
      ...
      <div className="mx-auto px-4 py-4">
        <div className="bg-blue-50 border border-blue-300 rounded-lg p-4">
          <p className="text-blue-900 text-sm">
            <strong>Note:</strong> This is a community database stored on
            Netlify. Know a specific company using styrofoam?{" "}
            <button
        ...
        <div className="mx-auto px-4 py-4">
          <div className="bg-white rounded-lg shadow-lg p-6 border-2 border-red-300">
            <h3 className="text-2xl font-bold mb-4 text-gray-900">
              Report a Styrofoam Offender
            </h3>
            <p className="text-gray-600 mb-4">
              Help build this database by reporting companies that use excessive
              styrofoam packaging.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-semibold mb-1">
                  Products with Styrofoam * (comma-separated)
                </label>
                <input
                  type="text"
                  required
              ...
              <p className="text-xs text-gray-500">
                Submissions are stored permanently in Netlify Blobs and appear
                immediately.
              </p>
            </form>
          </div>
                ...
                <div className="flex items-center justify-between text-xs text-gray-500">
                  ...
                  <span
                    className={`px-2 py-1 rounded font-semibold ${
                      company.severity === "high"
                        ? "bg-red-200 text-red-800"
                        : company.severity === "medium"
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-700">
                Replaced styrofoam with bamboo and mushroom-based packaging
                starting in 2008-2012. Now uses mostly sustainable materials.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-xl mb-2">McDonald's</h3>
              <p className="text-gray-700">
                Eliminated EPS packaging in 1990 under pressure from
                environmental groups. Committed to 100% sustainable packaging.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-bold text-xl mb-2">Dunkin'</h3>
              <p className="text-gray-700">
                Eliminated EPS foam cups in 2018, switched to double-walled
                paper cups.
              </p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-700">
                Never used foam cups - has always used paper cups with dome
                lids.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white mt-16 py-8">
        <div className=" mx-auto px-4">
          ...
          <ul className="space-y-2 text-gray-300 mb-6">
            <li>
              • Contact companies directly and demand sustainable alternatives
            </li>
            <li>
              • Choose companies that use paper, cardboard, or biodegradable
              packaging
            </li>
            <li>• Leave reviews mentioning excessive styrofoam packaging</li>
            <li>
              • Support legislation banning single-use styrofoam (12 U.S. states
              + DC have bans)
            </li>
            <li>• Share this site to raise awareness</li>
            <li>
              • Reuse styrofoam peanuts if you receive them, or take them to
              shipping stores
            </li>
            <li>
              • Find local EPS recycling facilities (they do exist, but are
              rare)
            </li>
          </ul>
          <div className="border-t border-gray-700 pt-4">
            <p className="text-sm text-gray-400">
              <strong>About this site:</strong> This is a community-driven
              database to raise awareness about styrofoam pollution. All data is
              stored in Netlify Blobs and persists permanently. Anyone can
              contribute reports.
            </p>
            <p className="text-xs text-gray-500 mt-2">
              Note: "Styrofoam" is actually a Dow Chemical trademark for
              extruded polystyrene (XPS) insulation. This site focuses on
